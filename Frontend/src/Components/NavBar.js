          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item" style={{ marginLeft: "400px" }}>
                <a className="nav-link" ><Link to="/" style={{ color: "red", textDecoration: "none" }}>Home</Link></a>
              </li>
              <li className="nav-item">
                <a className="nav-link" style={{ marginLeft: "100px" }}><Link to="/products" style={{ color: "red", textDecoration: "none" }}>Products</Link></a>
              </li>
              <li className="nav-item">
                <a className="nav-link" style={{ marginLeft: "100px" }}><Link to="/myprofile" style={{ color: "red", textDecoration: "none" }}>Orders </Link></a>
              </li>

              <li>
                <button className="btn btn-light" style={{ marginLeft: "400px", height: "43px" }}><Link to="/Cart"><FontAwesomeIcon icon={faShoppingCart} style={{ color: "black" }} /> &nbsp;Cart <span className="d-flex align-items-center justify-content-center counter">{props.count1}</span></Link></button>
              </li>
