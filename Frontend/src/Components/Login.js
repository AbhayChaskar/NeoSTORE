...
export default function Login() {
    ...
    return (
        <div >
            ...
            <br />
            <button className="btn" style={{ marginLeft: "500px" }}><Link to="/register" style={{textDecoration:"none", color:"red"}}>Register Now</Link></button>&nbsp;|&nbsp;<button className="btn"><Link to="/forgotPassword" style={{textDecoration:"none", color:"red"}}>Forgot Password</Link></button>
            <Footer />
        </div>
    )
}
