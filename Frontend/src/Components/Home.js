...
export default function Home() {
  ...
  //route to single product details
  const singleitem = (id) => {
    History.push(
      {
  ...
  return (
    <div>
      ...
      <div className="container row">
        <h3 className="text-center" style={{ marginLeft: "120px", marginTop: "30px",marginBottom:"20px",color:"red" }}>Upcoming Designs<i className="fas fa-sign-out-alt"></i></h3>
      </div>
      <hr/>
      <div className="container row">
        <h3 className="text-center" style={{ marginLeft: "120px", marginTop: "30px",marginBottom:"20px",color:"red" }}>Recent Popular<i className="fas fa-sign-out-alt"></i></h3>
      </div>
      <div className="container row" style={{ marginLeft: "250px" }}>
        {data.map((data, key) =>

        //enter below after classname before style
          <div className="card hov" key={data._id} style={{ width: "300px", height: "350px", padding: "10px", marginLeft: "20px", marginTop: "20px" }} >
            ...
            <div className="card-body">
              ...
              <a href="#" className="btn btn-danger" style={{ marginLeft: "28%" }} onClick={() => addtocart(data)}>Add to Cart</a>
            </div>
      ...
      <button className=" btn btn-dark mt-3" style={{ marginLeft: "700px", width: "130px",marginBottom:"10px"  }} onClick={() => {
...
<div className="container row" style={{ marginLeft: "250px" }}>
        ...
        // key={data._id} //enter below after classname before style
          <div className="card hov"  style={{ width: "300px", height: "350px", padding: "10px", marginLeft: "20px", marginTop: "20px" }} >
            <img className="card-img-top" onClick={() => singleitem(data._id)} src={data.product_image} style={{ width: "100%", height: "200px" }} alt="Card image cap" />
            <div className="card-body">
              <h5 className="card-title text-primary text-center" onClick={() => singleitem(data._id)} style={{ fontSize: "15px" }} >{data.product_name}</h5>
              <p className="card-text text-center" onClick={() => singleitem(data._id)} style={{ fontWeight: "bold" }} >₹ {data.product_cost}</p>
