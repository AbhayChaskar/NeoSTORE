...
export default function MyProfile() {
    ...
    //validate values and set data in localstorage 
    const validate = (e) => {
        e.preventDefault();
    ...
    //validate address and set new address
            ...
            <div className='container row' style={{ marginLeft: "45px" }}>
                ...
                <div className='col-md-3'>
                    <div>
                        ...
                        <div>
                            <input type="file" className="formcontrol mt-3" style={{marginLeft:"17px" }} onChange={onFileChange} />
                            <button className="btn btn-danger" style={{ marginTop: "10px", marginLeft:"17px" }} type="button" onClick={submit} >upload<UploadIcon /></button>
                        </div>
                    </div><br />
                    <div>
                        <h5 className='text-danger text-center' >UserName: {data.fname} {data.lname}</h5>
                ...
                <div className='col-md-9'>
                    <Card sx={{ width: "560px", marginLeft: "100px", }}>
                        <CardContent>
                            {
                                editprof == 1 ? <><span style={{fontSize: "7mm", marginBottom: "10px", color:"red"}}>Your Profile</span>
                                    <hr />
                                    ...
                                    <button type="button" className="btn btn-outline-warning" onClick={() => setEditProf(0)}> <EditIcon fontSize="large" /></button></>
                                    :
                                    editprof == 0 ?
                                        <><h4>Profile</h4>
                                            <hr />
                                            {errors.length > 1 && <Alert severity="warning" >{errors}</Alert>}<br />
                                            <span style={{ fontWeight: "bolder" }}>First Name</span><span style={{ marginLeft: "100px" }}> <input type="text" className="form-control" style={{ width: "300px", marginTop: "-28px", marginLeft: "150px" }} name='fname' onChange={handler} placeholder={data.fname} /></span><br />
                                            <span style={{ fontWeight: "bolder", marginTop: "-20px" }}>Last Name</span><span style={{ marginLeft: "100px" }}> <input type="text" className="form-control" style={{ width: "300px", marginTop: "-28px", marginLeft: "150px" }} name='lname' onChange={handler} placeholder={data.lname} /></span><br />
                                            ...
                                            <span style={{ fontWeight: "bolder" }}>Mobile Number</span><span style={{ marginLeft: "100px" }}> <input type="text" className="form-control" style={{ width: "300px", marginTop: "-28px", marginLeft: "150px" }} name='mobile' onChange={handler} placeholder={data.mobile} /></span><br />
                                            <span style={{ fontWeight: "bolder" }}>Email</span><span style={{ marginLeft: "100px" }}> <input type="text" className="form-control" style={{ width: "300px", marginTop: "-28px", marginLeft: "150px" }} name='email' onChange={handler} placeholder={data.email} /></span><br />
                                        ...
                                        editprof == 2 ?
                                            <>
                                                <span style={{fontSize: "7mm", marginBottom: "10px", color:"red" }}>Saved Addresses</span><button style={{ marginLeft: "253px" }} onClick={() => setEditProf(3)} type="button" className="btn btn-outline-success"><AddIcon fontSize='large' /></button>
                                                <hr />
                                                {
                                                    fulladdress.map((data, index) =>
                                                        <Card sx={{ width: "500px", marginLeft: "10px", marginBottom: "10px"}} key={data._id}>
                                                            <CardContent>
                                                                ...
                                                                <button style={{ marginLeft: "250px" }} onClick={() => {
                                            ...
                                            editprof == 3 ?
                                                <>
                                                    <span style={{fontSize: "7mm", marginBottom: "10px", color:"red"}}>Add New Address</span>
                                                    <hr />
                                                    {errors.length > 1 && <Alert severity="warning" >{errors}</Alert>}<br />
                                                    <TextField
                                                ...
                                                editprof == 4 ?
                                                    <>
                                                        <span style={{fontSize: "7mm", marginBottom: "10px", color:"red"}}>Update Address</span><span style={{ fontStyle: "italic", marginLeft: "200px" }}>Edit For</span> <span style={{ fontWeight: "bold", marginLeft: "20px" }}>City :</span><span>{updateCity}</span>  <span style={{ fontWeight: "bold", marginLeft: "10px" }}>Pincode :</span><span >{updatePincode} </span>
                                                        <hr />
                                                        {errors.length > 1 && <Alert severity="warning" >{errors}</Alert>}<br />
                                                        <TextField
                                                            id="outlined-multiline-static"
                                                        ...
                                                        <TextField
                                                            ...
                                                            size="small"
                                                            variant="outlined" /><br /><br />
                                                        <button type="button" onClick={updateAddress} className="btn btn-outline-success" ><SaveIcon /></button>  <button type="button" style={{ marginLeft: "10px" }} onClick={() => setEditProf(2)} className="btn btn-outline-danger" ><CloseIcon fontSize="large" /></button>
                                                    </> : editprof == 5 ?

                                                        <>{
                                                            compare == 1 ?
                                                                <>
                                                                    <span style={{fontSize: "7mm", marginBottom: "10px", color:"red"}}>Enter Old Password</span>
                                                                    <hr />
                                                                    <TextField
                                                                        onChange={handler}
                                                                        name="password"
                                                                        ...
                                                                        size="small"
                                                                        variant="outlined" /><br />
                                                                    <button type="button" style={{ marginTop: "10px" }} onClick={checkifpasscorrect} className="btn btn-outline-success"><BackupIcon/></button>
                                                                </> : compare == 0 ?
                                                                    <>
                                                                        <span style={{fontSize: "7mm", marginBottom: "10px", color:"red"}}>Set New Password</span>
                                                                        <hr />
                                                                        {errors.length > 1 && <Alert severity="warning" >{errors}</Alert>}<br />
                                                                        <TextField
                                                                            onChange={handler}
                                                                        ...
                                                                        <TextField
                                                                            ...
                                                                            variant="outlined" /><br />
                                                                        {errors == "" ?
                                                                            <button className="btn btn-outline-success " onClick={setnewpassword} style={{ marginTop: "10px" }}><SaveIcon fontSize="large" /></button> :
                                                            ...
                                                            <>
                                                                <span style={{ fontSize: "7mm", marginBottom: "10px",color:"red" }}>Your Orders</span>
                                                                <hr />
                                                                {
                                                                    orderdata.map((data, index) =>
                                                                        <Card sx={{ width: "500px", marginLeft: "10px", marginBottom: "10px" }} key={data._id}>
                                                                            <CardContent>
                                                                                <span style={{ fontSize: "6mm", fontWeight: "bold" }}>Order {index + 1}</span><br/>Id: {data._id}<br />
                                                                                <br/>
                                                                                ...
                                                                                <br />
                                                                                <button className='btn btn-outline-danger' style={{ marginTop: "10px" }} onClick={() => {
                                                                                    History.push(
                                                                                        {
                                                                                            pathname: '/invoice',
                                                                                            state: { id: data._id }
